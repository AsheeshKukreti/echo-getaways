    ...
    <main className="min-h-screen bg-[rgb(255,251,244)] text-gray-900">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-24 text-center">
          <h1
            className="text-3xl sm:text-5xl font-serif font-extrabold leading-tight"
            data-aos="fade-up"
          >
            Crafted Experiences — Travel That Resonates
          </h1>
          <p
            className="mt-4 text-base sm:text-lg text-amber-100 max-w-2xl mx-auto"
            data-aos="fade-up"
            data-aos-delay="80"
          >
              ...
              >
                <div className="h-44 w-full overflow-hidden relative group">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="text-lg sm:text-xl font-semibold drop-shadow">{exp.title}</h3>
                  </div>
                </div>

                <div className="p-4">
                  <p className="text-gray-700 mb-3 text-sm sm:text-base">{exp.desc}</p>
